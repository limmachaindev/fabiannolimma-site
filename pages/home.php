 ...
 <section class="banner banner--style3">
        ...
        <div class="row gy-5 gx-4">
          <div class="col-lg-6 col-md-7">
            <div class="banner__content">
              ...
              <h1 class="banner__content-heading">Sistemas web <br ><span>Fabianno Limma</span></h1>
              <p class="banner__content-moto">Sistemas web personalizados e automatizados para sua empresa.
              </p>
          ...
          <div class="col-lg-6 col-md-5">
            <div class="banner__thumb">
              <img src="assets/images/about/home3/2.png" alt="banner-thumb" class="dark">
            </div>
          </div>
        </div>
      </div>
                ...
                <div class="about__thumb-image floating-content">
                  ...
                  <div class="floating-content__top-left">
                    <div class="floating-content__item">
                      ...
                      <p>de programação na web</p>
                    </div>
                  </div>
                  <div class="floating-content__bottom-right">
                    <div class="floating-content__item">
                      <h3> <span class="purecounter" data-purecounter-start="0" data-purecounter-end="125">125K</span>K+
                      </h3>
                      <p>de linhas de códigos escritos.</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div class="col-lg-6">
            <div class="about__content" data-aos="fade-left" data-aos-duration="800">
              <div class="about__content-inner">
                <h2>Porque nos escolher criar o software de sua empresa?</h2>
                ...
                <a href="#" class="trk-btn trk-btn--border trk-btn--primary">Saiba mais sobre a emrpesa</a>
              </div>
            </div>
          </div>
        </div>
  ...
  <section class="service padding-top padding-bottom">
    <div class="section-header section-header--max50">
      <h2 class="mb-15 mt-minus-5"><span>Produtos </span>oferecidos</h2>
      <p>Além de nosso produto principal, oferecemos serviços diversos, confira abaixo.</p>
    </div>
    <div class="container">
      <div class="service__wrapper">
        <div class="row g-4 align-items-center">
          <div class="col-sm-6 col-md-6 col-lg-4">
            <div class="service__item" data-aos="fade-up" data-aos-duration="300">
    ...
    <div class="container">
      <div class="cta__wrapper">
        <div class="cta__newsletter justify-content-center">
          <div class="cta__newsletter-inner">
