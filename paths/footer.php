 ...
 <a href="index-2.html" class="footer__about-logo"><img src="assets/images/logo/logo.png" style="height: 120px;"></a>
                <p class="footer__about-moto ">Soluções web para sua empresa.</p>
              </div>
            </div>
              ...
              <div class="footer__links">
                ...
                <div class="footer__links-content">
                  <ul class="footer__linklist">
                    <li class="footer__linklist-item"> <a href="about.html">Sobre nós</a></li>
                    <li class="footer__linklist-item"> <a href="service.html">Serviços e produtos</a> </li>
                    <li class="footer__linklist-item"> <a href="#">Blogs e noticias</a></li>
                  </ul>
                </div>
              </div>
            </div>
        ...
        <div class="footer__bottom">
          <div class="footer__end">
            <div class="footer__end-copyright">
              <p class=" mb-0">© <?php echo date('Y');?> - Todos os direitos reservados <a href="#" target="_blank">Sistemas Fabianno Limma</a> </p>
            </div>
            <div>
              <ul class="social">
